...
class Login(GridLayout):
    ...
    def logging_in(self,instance):
        ...
        if username=='the wenses media' and password=='business':
            sbc.home.update_info(username)
            sbc.screen_manager.current='home'
        elif username=='mwanyuma' and password=='forex':
            sbc.home.update_info(username)
            sbc.screen_manager.current='home'
        elif username=='chizenga' and password=='root':
            sbc.home.update_info(username)
            sbc.screen_manager.current='home'
        elif username=='peter ndaki' and password=='forex':
            sbc.home.update_info(username)
            sbc.screen_manager.current='home'
        else:
...
class Home(GridLayout):
    def __init__(self,**kwargs):
        ...
        self.forex=Button(text='FOREX CHARTS',background_color=(0,200/255.0,200/255.0,1))
